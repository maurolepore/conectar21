...
## Líderes de "micro" comunidades en mi trabajo {.flexbox .vcenter}

<img src=http://i.imgur.com/0GfdbQY.png width=900>

## Que logramos cambiar? | Helpdesk: Soporte en vivo con cita
...
<img src=FIXME width=900>

## Ejemplo: Cómo lo hicimos? {.flexbox .vcenter}

* Mostrando pasión por los proyectos que creamos.
* Conectando nuestras ideas y gente mediante plataformas de comunicación.
* Apartatándones para favorecer la comunicación entre miembros.
...
## La palabra clave | Gracias! {.flexbox .vcenter}
